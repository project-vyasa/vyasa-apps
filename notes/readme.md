...
| Repo | Path | Role |
|------|------|------|
| **vyasa-apps** (here) | `/Users/anand/Projects/project-vyasa/vyasa-apps` | Viewer, Sanskrit Studio, Vyasa Studio, apps docs (`apps/docs`) |
...
| [`../apps/docs`](../apps/docs/README.md) | Public Viewer + Vyasa Studio + Sanskrit Studio user docs (Starlight) |
